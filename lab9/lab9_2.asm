...
main proc
	...
	;pdf 4.10 w przykladzie odrazu wykorzystanie procedury TextOutA ktora rysuje bezposrednio tekst z bufora na kanwe, oraz UpdateWindow ktora przerysowywuje okno
