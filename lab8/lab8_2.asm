...
.data
	...
	komunikat3 db 'Podaj drug¹ liczbê rzeczywist¹ (. jako reparator): ',0
	
	komunikatWynik db 'x/y+z wynosi: ',0
.code

main proc
	; x/y+z
	; 5/2 + 2.5 = 2.5 + 2.5 = 5.000000
	; 10.0/3.0 + 5.5 = 3.(3) + 5.5 = 8.8(3)
...
;konwresja bufora na typ REAL10 i zapis w zmiennnej y
	...
	invoke StdIn, OFFSET bufor, rozmiarbufora
	invoke StripLF, OFFSET bufor
;konwresja bufora na typ REAL10 i zapis w zmiennnej z
