...
_DATA SEGMENT
	...
	iloscProb	DD	0
	odgadnieta	DD	1000
	zwyciestwo	DB	0Dh,0Ah,"Jestes zwyciezca! Trafiles za %ld razem.",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
	rozmiarzwyciestwo	DD	$ - zwyciestwo	;liczba znaków w tablicy
	podajWieksza	DB	0Dh,0Ah,"Niestety nie trafiles. Podaj wieksza liczbe.",0Dh,0Ah,0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
	rozmiarpodajWieksza	DD	$ - podajWieksza	;liczba znaków w tablicy
	podajMniejsza	DB	0Dh,0Ah,"Niestety nie trafiles. Podaj mniejsza liczbe.",0Dh,0Ah,0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
	rozmiarpodajMniejsza	DD	$ - podajMniejsza	;liczba znaków w tablicy
