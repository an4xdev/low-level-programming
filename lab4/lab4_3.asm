...
_DATA SEGMENT
	...
	zaprA	DB	0Dh,0Ah,"Proszê podaæ liczbê: [+Enter]: ",0
	ALIGN	4
	rozmA	DD	$ - zaprA	;liczba znaków w tablicy
	zmA	DD	1	; argument A
	wzor	DB	0Dh,0Ah,"Wprowdzona liczba pomnozona przez 7 bez uzycia mul = %ld",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
