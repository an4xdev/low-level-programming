...
_DATA SEGMENT
	...
	zaprA	DB	0Dh,0Ah,"Proszê podaæ liczbê 8bitowa: [+Enter]: ",0
	ALIGN	4
	rozmA	DD	$ - zaprA	;liczba znaków w tablicy
	zmA		DB	1	; argument A
	zaprB	DB 0Dh,0Ah,"Proszê podaæ liczbê: [+Enter]: ",0
	ALIGN	4
	rozmB	DD $ - zaprB
	zmB		DD	2; 
	wynikBin	DB	0Dh,0Ah,"Wynik w postaci binarnej: ",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
	rozmWB	DD	$ - wynikBin	;liczba znaków w tablicy
...
;--- wyœwietlenie "wynik w postaci binarnej"---
	push	0		; rezerwa, musi byæ zero
	push	OFFSET rout 	; wskaŸnik na faktyczn¹ liczba wyprowadzonych znaków 
	push	rozmWB		; liczba znaków
	push	OFFSET wynikBin 	; wska¿nik na tekst
 	push	hout		; deskryptor buforu konsoli
	call	WriteConsoleA	; wywo³anie funkcji WriteConsoleA  

;--- wyprowadzenie wyniku obliczeñ w postaci binarnej ---
	push	EAX
...
;---- 
@@:    
    push   EDX   ; do EDX procesor mo¿e zapisaæ wynikBin mno¿enia 
   mov   EDI, 10 
