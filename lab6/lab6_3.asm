...
_TEXT SEGMENT
main proc
    ;Napisz program, wczytuj¹cy liczby z pliku w formacie z zad2 i wyœwietlaj¹cy je na konsoli.
    ...
    L1:
        mov counter, ECX
        ;mov EDX, OFFSET buforForReading
        invoke ReadFile, fileHandler, offset buforForReading, 4, numberOfBytesWritten, 0
        
        mov ESI, OFFSET buforForReading
        mov EDI, OFFSET buforForWriting
        ;invoke dwtoa, EAX, OFFSET buforForWriting
        ...
        invoke StdOut, OFFSET buforForWriting
