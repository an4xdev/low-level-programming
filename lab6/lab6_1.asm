...
buforForFolderName db "\Grupa1",0
...
main proc
      ...
      ;Na podstawie materiałów uzupełniających i plików do zajęć utwórz program, tworzący katalog: GrupaN – gdzie N jest numerem twojej grupy.

      invoke GetCurrentDirectoryA,128,OFFSET buforForPath
      invoke lstrcatA,OFFSET buforForPath,OFFSET buforForFolderName
      invoke CreateDirectoryA,OFFSET buforForPath,0
	push 0
	call ExitProcess
main endp
_TEXT	ENDS
